...
from elliot.recommender.ann.item_fair_ann.item_fair_ann_similarity import LSHSimilarity
...
class ItemFairANN(RecMixin, BaseRecommenderModel):
    r"""
    Fair ANN recommendations: item-to-item collaborative filtering, with equal opportunities for all the items in the neighborhood
