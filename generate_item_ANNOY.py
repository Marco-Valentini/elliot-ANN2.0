...
#SBATCH --output=item_annoy_out/log_annoy_item_n={neighbors}_t={n_trees}_k={search_k}.out
#SBATCH --error=item_annoy_err/log_annoy_item_n={neighbors}_t={n_trees}_k={search_k}.err
