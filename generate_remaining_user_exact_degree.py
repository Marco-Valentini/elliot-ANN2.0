...
#SBATCH --job-name=job_user_{n_hash}_{similarity}_{n_tables}
#SBATCH --time=24:00:00
#SBATCH --nodes=1
#SBATCH --mem=256GB
#SBATCH --cpus-per-task=2
#SBATCH --output=user_out_ed/log_user_{n_hash}_{similarity}_{n_tables}.out
#SBATCH --error=user_err_ed/log_user_{n_hash}_{similarity}_{n_tables}.err
...
python script_run_generic.py --config_path 'config_run_exact_degree/user_experiment_yelp_sim={similarity}_n_hash={n_hash}_n_tables={n_tables}_sampling=exact_degree_neighbors=500.yml'
"""
