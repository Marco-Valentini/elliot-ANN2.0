...
#SBATCH --output=log_user_[{n_hash[0]}_{n_hash[1]}]_{sampling_strategy}_{neighbors}.out
#SBATCH --error=log_user_[{n_hash[0]}_{n_hash[1]}]_{sampling_strategy}_{neighbors}.err
